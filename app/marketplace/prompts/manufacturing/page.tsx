...
export default function ManufacturingPromptsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Manufacturing Prompts</h1>
        <p className="text-muted-foreground mt-2">
          Prompts for manufacturing operations, production planning, and assembly management in NetSuite
        </p>
      </div>
