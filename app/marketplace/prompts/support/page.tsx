...
export default function SupportPromptsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Support Prompts</h1>
        <p className="text-muted-foreground mt-2">
          Prompts for customer support, case management, and help desk operations in NetSuite
        </p>
      </div>
