...
export default function InventoryPromptsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Inventory Prompts</h1>
        <p className="text-muted-foreground mt-2">
          Prompts for inventory management, stock tracking, and warehouse operations in NetSuite
        </p>
      </div>
